...
<div class="layui-body">
  <%-- <div class="layui-tab layui-tab-brief" lay-filter="tab"> --%>
    <span class="btn-toolbar fixed-icon">
      ...
      <i class="layui-icon cu" id="i-warehouse" title="查看库存">库存</i>
    </span>
    <%-- tab内容展示 -->
    <!-- <div class="layui-tab-content"> -->
      ...
      <!-- <div class="layui-tab-item layui-show"> -->
        ...
        <div class="head-title">
        	<strong>记账凭证</strong>
        	<!-- <div class="dn" id="paging">
        		<span class="paging_But">上一张</span>
        		<span class="paging_But">下一张</span>
        	</div> -->
        </div>
        <div class="book-keeping cl" id="book-keeping">
          ...
          <div class="book-select cl">
            ...
            <div class="more">
            	...
            	<ul>
            		<li class="preservation">保存为凭证模板</li>
            		<li class="generate">从模板生成凭证</li>
            	</ul>
            </div>
