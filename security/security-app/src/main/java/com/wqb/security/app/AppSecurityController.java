...
package com.wqb.security.app;

import com.wqb.security.app.social.AppSingUpUtils;
import com.wqb.security.core.properties.SecurityConstants;
import com.wqb.security.core.social.SocialController;
import com.wqb.security.core.social.support.SocialUserInfo;
...
public class AppSecurityController extends SocialController {
    ...
    public ResponseEntity postAccessToken(Principal principal, @RequestParam Map<String, String> parameters) {
        ...
        return ResponseEntity
                ...
                .body(new Response<>().setMessage(message).setData(result.getBody()));
    }
